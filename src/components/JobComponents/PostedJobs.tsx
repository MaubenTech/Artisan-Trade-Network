	...
	return (
		<View style={{ gap: 20 }}>
			{jobs.map((job) => {
				return (
					<>
						<Link style={styles.job} asChild href={"/(jobs)/PostedJobDetails"}>
							<TouchableOpacity style={styles.jobDetails} key={job.jobTitle}>
								...
								<View style={styles.jobDetailContainer}>
									...
									<Text style={styles.jobServiceCategory}>
										{job.jobServiceCategory}
									</Text>
									<Text
										style={styles.jobDetailContent}
										...
										<View style={styles.jobStatus}>
											<View
												style={[
													...
													setStatusBackgroundColor(job.jobStatus),
												]}
											></View>
