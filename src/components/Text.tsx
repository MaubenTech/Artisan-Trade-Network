...
export const Text = forwardRef<RNText, TextProps>(({ children, style, maxFontSizeMultiplier = 1, ...props }, ref) => {
	...
	return (
		<RNText ref={ref} style={[{ fontFamily }, remainingStyles]} maxFontSizeMultiplier={maxFontSizeMultiplier} {...props}>
			{children}
		</RNText>
	);
});

export const TextInput = forwardRef<RNTextInput, TextInputProps>(({ children, style, maxFontSizeMultiplier = 1, ...props }, ref) => {
	const flattenedStyle = StyleSheet.flatten(style ?? {});
	...
	return (
		<RNTextInput ref={ref} style={[{ fontFamily }, remainingStyles]} maxFontSizeMultiplier={maxFontSizeMultiplier} {...props}>
			{children}
		</RNTextInput>
	);
});
