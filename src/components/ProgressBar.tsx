...
const ProgressBar: React.FC<ProgressBarProps> = ({ status, numerator, denominator, showCompleteLevel }) => {
	...
	return (
		<View style={styles.container}>
			...
			<Progress.Bar progress={calculateProgress()} width={null} height={10} color={colors.mainColor} unfilledColor={colors.offMainColor} borderWidth={0} borderRadius={5} style={styles.progressBar} />
		</View>
	);
};
