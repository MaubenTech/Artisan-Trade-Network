			...
			<View style={styles.container}>
				{JobReviews.map((jobReview, idx) => {
					return (
						<>
							<View
								style={styles.jobReviewContainer}
								key={jobReview.jobReviewTitle}
							>
								<Text style={styles.jobReviewHeader}>
									{jobReview.jobReviewHeader}
								</Text>
								<Text style={styles.jobReviewTitle}>
									{jobReview.jobReviewTitle}
								</Text>
