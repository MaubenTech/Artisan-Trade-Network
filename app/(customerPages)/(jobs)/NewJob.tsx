        ...
        <View style={styles.container}>
            ...
            <SafeAreaView style={styles.newJobContent}>
                <ScrollView contentContainerStyle={{ paddingBottom: 60 }}>
                        ...
                        <View style={styles.uploadedMediaContainer}>
                            {selectedImages.length > 0 ? (
                                selectedImages.map((selectedImage) => {
                                    return <Image source={{ uri: selectedImage.uri }} key={selectedImage.assetId} style={styles.uploadedImage} />;
                                })
                            ) : (
                                <>
                                    <TouchableOpacity
                    ...
                    <ButtonGroup positiveOption="Proceed" negativeOption="Cancel" href={`/(customerPages)/JobLocation?images=${encodeURIComponent(encodedImages)}`} paddingHorizontal={30} isNop />
                </ScrollView>
            </SafeAreaView>
        </View>
    );
